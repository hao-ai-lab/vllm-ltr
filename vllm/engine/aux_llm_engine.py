...
class AUXLLMEngine:
    ...
    def obtain_aux_scores(self, seq_groups):
        ...
        for seq_group_original in seq_groups: 
            ...
            prompt_token_ids = self.encode_request(
                ...
                lora_request=lora_request)[:self.scheduler.scheduler_config.max_model_len]
            ...
            seq_group = SequenceGroup(seq_group_original.request_id, [seq], sampling_params,
        ...
        while self.has_unfinished_requests():
            ...
            for output in step_outputs:
                if output.finished:
                    ...
                    ret.append(output.outputs[0].aux_model_score)
        ...
        return ret
        #print("obtain: ", len(seq_groups), t2 - t0, count_step)
    def add_request(
        self,
        request_id: str,
        prompt: Optional[str],
    ...
    def step(self) -> List[RequestOutput]:
        ...
        #print('exec ', len(seq_group_metadata_list))
