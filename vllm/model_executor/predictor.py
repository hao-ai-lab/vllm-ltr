...
class LTRModel(nn.Module):
    ...
    """
    def __init__(self, input_layer, output_layer, pred_layer_idx):
        """
        ...
        self.pred_layer_idx = pred_layer_idx

    def prepare_for_output(self, x):
        """
    ...
    def forward(self, x):
        ...
        """
        return self.output_layer(self.prepare_for_output(x))
    ...
    def score(self, x):
        ...
        """
        return self.output_layer.score(self.prepare_for_output(x))
...
def predictor_model(fc_model, post_model, n_features, pred_layer_idx):
    """
    ...
    model = LTRModel(fc_model, OutputLayer(d_model, **post_model), pred_layer_idx)
